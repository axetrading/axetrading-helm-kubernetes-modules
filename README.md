...
| <a name="input_statsd_config"></a> [statsd\_config](#input\_statsd\_config) | StatsD exporter configuration | `map` | <pre>{<br>  "high_availability_enabled": false,<br>  "target_group_arn": null<br>}</pre> | no |
